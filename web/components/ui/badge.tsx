...
const badgeVariants = cva(
  'inline-flex items-center justify-center gap-1.5 rounded border px-2 py-0.5 text-2xs font-semibold tracking-wider uppercase w-fit whitespace-nowrap shrink-0 transition-colors',
  {
    variants: {
      variant: {

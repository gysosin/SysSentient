...
[PRIVACY.md](https://github.com/gysosin/SysSentient/blob/main/docs/PRIVACY.md).
...
in [PERFORMANCE.md](https://github.com/gysosin/SysSentient/blob/main/docs/PERFORMANCE.md).
